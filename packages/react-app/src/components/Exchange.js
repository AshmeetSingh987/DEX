...
const Exchange=({ pools }) => {
    ...
    const hasEnoughBalance=fromValueBigNumber
        .lte(fromTokenBalance??parseUnits("0"));

    const { state: swapApproveState, send: swapApproveSend }=useContractFunction(fromTokenContract, "approve", {
        transactionName: "onApprovalRequested",
    ...
    return (
        <div className="flex flex-col w-full items-center">
            <div className="mb-8">
                ...
                />
                <Balance tokenBalalnce={fromTokenBalance} />
            </div>
            <div className="mb-8 w-[100%">
                <AmountOut
                    ...
                    pairContact={pairAddress}
                    currencyValue={toToken}
                    onSelect={onTokenTokenChange}
                    currencies={counterpartTokens}

                />
                <Balance tokenBalalnce={toTokenBalance} />
            </div>
                ...
                <button
                    ...
                    className={
                        `${canApprove?
                            ...
                            "bg-site-pink text-white":"bg-site-dim2 text-site-dim2"}${styles.actionButton}`
                    }>
